		...
		me.game.world.addChild(new me.Sprite(0, 0, me.loader.getImage("exp-screen")), -10); // TODO
                ...
                me.game.world.addChild(new (me.Renderable.extend({
                    ...
                    draw: function(renderer){
                        ...
                        this.font.draw(renderer.getContext(), "F2: ADD STARTING GOLD " + game.data.exp2.toString() + " PRICE: " + "$" + ((game.data.exp2 + 2) * 10) + ".00", this.pos.x + 200, this.pos.y + 150);
                        this.font.draw(renderer.getContext(), "F3: INCREASE ATTACK DAMAGES " + game.data.exp3.toString() + " PRICE: " + "$" + ((game.data.exp3 + 3) * 10) + ".00", this.pos.x + 200, this.pos.y + 200);
                        this.font.draw(renderer.getContext(), "F4: INCREASE STARTING HEALTH " + game.data.exp4.toString() + " PRICE: " + "$" + ((game.data.exp4 + 4) * 10) + ".00", this.pos.x + 200, this.pos.y + 250);
